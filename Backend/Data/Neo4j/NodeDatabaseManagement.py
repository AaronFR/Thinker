...
class NodeDatabaseManagement:
    ...
    def update_user_balance(self, amount: float) -> None:
        ...
        """
        if amount > 0:
            # ToDo: until payments are integrated only balance deductions should be possible.
            logging.error("!!! - Attempting to increase balance before payments integration")
            raise Exception("!!! - Attempting to increase balance before payments integration")
