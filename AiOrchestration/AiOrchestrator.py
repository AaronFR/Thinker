...
class AiOrchestrator:
    ...
    def _handle_rerun(
        ...
        new_messages = generate_messages("", judgement_criteria, responses, self.input_files, model)
        return Utility.execute_with_retries(
    ...
    def execute_function(
        ...
        messages = generate_messages(system_prompts, user_prompts, input_files=self.input_files, model=model)
        response = Utility.execute_with_retries(
