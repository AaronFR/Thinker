...
class AiOrchestrator:
    ...
    def execute(self,
        ...
        if streaming:
            ...
            if rerun_count == 1:
                ...
                messages = self.generate_messages("", judgement_criteria, responses, model)
                response = Utility.execute_with_retries(lambda: self.prompter.get_open_ai_response(messages, model))
    ...
    def generate_messages(self,
                          ...
                          assistant_messages: List[str] = None,
                          model: ChatGptModel = ChatGptModel.CHAT_GPT_4_OMNI_MINI) -> List[Dict[str, str]]:
    ...
    def build_role_messages(self,
        ...
        (I honestly have no idea how that's remotely possible but whatever, I'm not the one being paid $150,000+ to muck about)
        """
