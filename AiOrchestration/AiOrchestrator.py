...
class AiOrchestrator:
    ...
    def __init__(self, input_files: List[str]):
        ...
        :param prompter: An instance of the ChatGptWrapper class, responsible for creating the prompts sent to the OpenAI API.
    ...
    def generate_messages(input_files, system_prompts: List[str] | str, user_prompts: List[str]) -> List[Dict[str, str]]:
        ...
        messages = AiOrchestrator.generate_role_messages(system_prompts, input_files, user_prompts)
